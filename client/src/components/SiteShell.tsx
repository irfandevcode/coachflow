    ...
    <div className="min-h-screen bg-[#fbfdff] text-[#0b1f3a]">
      ...
      <footer className="site-footer">
        ...
        <div className="container grid gap-12 py-14 md:grid-cols-[1.35fr_1fr_1fr_1fr] md:py-20">
          ...
          <div><p className="footer-heading">Stay connected</p><div className="footer-links"><a href="mailto:visitascendra@gmail.com"><Mail size={15} /> visitascendra@gmail.com</a><a href="https://wa.me/917569819144?text=Hi%20CoachFlow%2C%20I%E2%80%99d%20like%20help%20reviewing%20my%20client%20acquisition%20system." target="_blank" rel="noreferrer"><MessageCircle size={15} /> WhatsApp: +91 75698 19144</a><Link href="/privacy">Privacy policy</Link><Link href="/terms">Terms of service</Link></div></div>
        </div>
