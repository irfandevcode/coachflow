  ...
  return (
    <PageFrame>
      ...
      <section className="section-padding bg-[#f4f8fd]">
        <div className="container"><SectionIntro eyebrow="The CoachFlow system" title={<>From scattered touchpoints to a <span className="text-[#1261d6]">connected path.</span></>} body="We design the full journey around the way your prospects actually make decisions — not just a pretty page at the end of the process." />
